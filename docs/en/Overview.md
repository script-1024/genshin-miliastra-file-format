...
[File Size:         4 bytes]
[Version:           4 bytes]
[Head Magic Number: 4 bytes]
[Type:              4 bytes]
[Content Length:    4 bytes]

(Content: Arbitrary Length)
...
## Did you know?
This is a minimal example of a valid GIA file that can pass game verification, but leaves nothing on the Manage Asset Import/Export interface! 🤪
...
| Content           |-------------| Empty       |
| Tail Magic Number |`00 00 06 79`| Correct ✅  |
